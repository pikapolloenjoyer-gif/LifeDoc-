...
if __name__ == "__main__":
 ...
 while True:
   ...
   if opcion == "1":
     ...
     tabla = Table("Dias", style="black", title= hoy_mes_año)
     ...
     del to_do_list[dias]
     print ("Día eliminado correctamente")
   elif opcion == "5":
     print("Saliendo...")
     break
   else:
